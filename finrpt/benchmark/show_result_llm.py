...
def display_result_pairwise(args):
    ...
    print(f"Input file: {input_file}")
    df_all_ = pd.read_json(input_file, lines=True)
    for i in range(6):
        df_all = df_all_
        df_all['g1_winner'] = df_all['g1_winners'].apply(lambda x: x[i])
        df_all['g2_winner'] = df_all['g2_winners'].apply(lambda x: x[i])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--judge-model", type=str, default="gpt-4o-copy")
