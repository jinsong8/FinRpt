...
october_6th_price = nvda.history(start="2024-10-01", end="2024-10-06")['Close'].iloc[-1]
september_6th_price = nvda.history(start="2024-09-01", end="2024-09-06")['Close'].iloc[-1]
